...
summary_borer %>%
  ggplot(aes(percent_incidence_borer)) +
  geom_density()
...
summary_borer %>%
  ggplot(aes(sample=percent_incidence_borer)) +
  stat_qq() +
  stat_qq_line()

summary_borer %>%
  ggplot(aes(`Corn Type`, percent_incidence_borer)) +
  geom_boxplot()

summary_borer %>%
  ggplot(aes(Treatment, percent_incidence_borer)) +
  geom_boxplot()
...
borer_joined_ev %>%
  ...
  labs(x = "Monthly average temperature (C)", y = "Incidence Borer") +
...
borer_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average wind speed (km/h)", y = "Incidence Borer") +
  annotate("label", x = 4, y = 8,  
...
borer_joined_ev %>%
  ...
  labs(x = "Monthly average humidity (%)", y = "Incidence Borer") +
  annotate("label", x = 50, y = 8,  
...
borer_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average rainfall (mm)", y = "Incidence Borer") +
...
semilooper_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence Semilooper") +
  annotate("label", x = 27, y = 8,  
...
semilooper_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average wind speed (km/h)", y = "Incidence Semilooper") +
  annotate("label", x = 4, y = 8,  
...
semilooper_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly average humidity (%)", y = "Incidence Semilooper") +
  annotate("label", x = 50, y = 8,  
...
semilooper_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average rainfall (mm)", y = "Incidence Semilooper") +
  annotate("label", x = 0.5, y = 10,  
...
earworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence Earworm") +
  annotate("label", x = 27, y = 13,  
...
earworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average wind speed (km/h)", y = "Incidence Earworm") +
  annotate("label", x = 4, y = 13,  
...
earworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly average humidity (%)", y = "Incidence Earworm") +
  annotate("label", x = 50, y = 13,  
...
earworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average rainfall (mm)", y = "Incidence Earworm") +
...
hopper_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence Hopper") +
  annotate("label", x = 27, y = 8,  
...
hopper_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average wind speed (km/h)", y = "Incidence Hopper") +
  annotate("label", x = 4, y = 8,  
...
hopper_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly average humidity (%)", y = "Incidence Hopper") +
  annotate("label", x = 50, y = 8,  
...
hopper_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average rainfall (mm)", y = "Incidence Hopper") +
  annotate("label", x = 0.5, y = 10,  
...
cutworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence Cutworm") +
  annotate("label", x = 27, y = 8,  
...
cutworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average wind speed (km/h)", y = "Incidence Cutworm") +
  annotate("label", x = 4, y = 8,  
...
cutworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly average humidity (%)", y = "Incidence Cutworm") +
  annotate("label", x = 50, y = 8,  
...
cutworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average rainfall (mm)", y = "Incidence Cutworm") +
  annotate("label", x = 0.5, y = 10,  
...
armyworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence Armyworm") +
  annotate("label", x = 27, y = 12,  
...
armyworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average wind speed (km/h)", y = "Incidence Armyworm") +
  annotate("label", x = 5, y = 15,  
...
armyworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly average humidity (%)", y = "Incidence Armyworm") +
...
armyworm_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average rainfall (mm)", y = "Incidence Armyworm") +
...
aphids_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence Aphids") +
  annotate("label", x = 27, y = 12,  
...
aphids_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average wind speed (km/h)", y = "Incidence Aphids") +
  annotate("label", x = 5, y = 15,  
...
aphids_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly average humidity (%)", y = "Incidence Aphids") +
  annotate("label", x = 50, y = 12,  
...
aphids_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average rainfall (mm)", y = "Incidence Aphids") +
  annotate("label", x = 0.5, y = 12,  
...
detach("package:MASS", unload = TRUE)
detach("packages:stats", unload = TRUE)
```
...
faw_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence FAW") +
  annotate("label", x = 27, y = 25,  
           label = temp_faw_eqn,
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
...
faw_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average wind speed (km/h)", y = "Incidence FAW") +
  annotate("label", x = 4, y = 25,  
           label = wind_faw_eqn,
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
...
faw_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly average humidity (%)", y = "Incidence FAW") +
  annotate("label", x = 50, y = 35,  
           label = humid_faw_eqn,
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
...
faw_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average rainfall (mm)", y = "Incidence FAW") +
  annotate("label", x = 0.5, y = 25,  
           label = rain_faw_eqn,
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
...
# faw
print(paste(round(correlation::cor_to_p(cor_faw_wind_incidence, 2528)$p, 5), "correlation p-value of wind speed and FAW incidence."))
print(paste(round(correlation::cor_to_p(cor_faw_temp_incidence, 2528)$p, 5), "correlation p-value of temperature and FAW incidence."))
print(paste(round(correlation::cor_to_p(cor_faw_humid_incidence, 2528)$p, 5), "correlation p-value of humidity and FAW incidence."))
print(paste(round(correlation::cor_to_p(cor_faw_rain_incidence, 2528)$p, 5), "correlation p-value of rainfall and FAW incidence."))

# aphids
print(paste(round(correlation::cor_to_p(cor_aphids_wind_incidence, 2528)$p, 5), "correlation p-value of wind speed and aphids incidence."))
print(paste(round(correlation::cor_to_p(cor_aphids_temp_incidence, 2528)$p, 5), "correlation p-value of temperature and aphids incidence."))
print(paste(round(correlation::cor_to_p(cor_aphids_humid_incidence, 2528)$p, 5), "correlation p-value of humidity and aphids incidence."))
print(paste(round(correlation::cor_to_p(cor_aphids_rain_incidence, 2528)$p, 5), "correlation p-value of rainfall and aphids incidence."))


# borer
print(paste(round(cor_borer_wind_incidence, 3), "correlation value of wind speed and Borer incidence."))
print(paste(round(cor_borer_temp_incidence, 3), "correlation value of temperature and Borer incidence."))
print(paste(round(cor_borer_humid_incidence, 3), "correlation value of humidity and Borer incidence."))
print(paste(round(cor_borer_rain_incidence, 3), "correlation value of rainfall and Borer incidence."))


# earworm
print(paste(round(cor_earworm_wind_incidence, 3), "correlation value of wind speed and Earworm incidence."))
print(paste(round(cor_earworm_temp_incidence, 3), "correlation value of temperature and Earworm incidence."))
print(paste(round(cor_earworm_humid_incidence, 3), "correlation value of humidity and Earworm incidence."))
print(paste(round(cor_earworm_rain_incidence, 3), "correlation value of rainfall and Earworm incidence."))


# Armyworm
print(paste(round(cor_armyworm_wind_incidence, 3), "correlation value of wind speed and Armyworm incidence."))
print(paste(round(cor_armyworm_temp_incidence, 3), "correlation value of temperature and Armyworm incidence."))
print(paste(round(cor_armyworm_humid_incidence, 3), "correlation value of humidity and Armyworm incidence."))
print(paste(round(cor_armyworm_rain_incidence, 3), "correlation value of rainfall and Armyworm incidence."))


# Cutworm
print(paste(round(cor_cutworm_wind_incidence, 3), "correlation value of wind speed and Cutworm incidence."))
print(paste(round(cor_cutworm_temp_incidence, 3), "correlation value of temperature and Cutworm incidence."))
print(paste(round(cor_cutworm_humid_incidence, 3), "correlation value of humidity and Cutworm incidence."))
print(paste(round(cor_cutworm_rain_incidence, 3), "correlation value of rainfall and Cutworm incidence."))

# Hopper
print(paste(round(cor_hopper_wind_incidence, 3), "correlation value of wind speed and Hopper incidence."))
print(paste(round(cor_temp_incidence, 3), "correlation value of temperature and Hopper incidence."))
print(paste(round(cor_hopper_humid_incidence, 3), "correlation value of humidity and Hopper incidence."))
print(paste(round(cor_hopper_rain_incidence, 3), "correlation value of rainfall and Hopper incidence."))
